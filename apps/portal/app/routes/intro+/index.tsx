  ...
  const SLIDES = [
    {
      video: '',
      title: 'Title',
      text: 'Celiac kitsch lyft enamel pin photo booth kinfolk subway tile, neutra before they sold out ramps. JOMO enamel pin pinterest banjo swag viral DIY sartorial.',
      button: (
