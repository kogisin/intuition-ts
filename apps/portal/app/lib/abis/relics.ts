export const relicsAbi = [
  ...
  { inputs: [], name: 'CannotIncreaseMaxSupply', type: 'error' },
  { inputs: [], name: 'CannotUpdatePermanentURI', type: 'error' },
  { inputs: [], name: 'InsufficientPayment', type: 'error' },
  { inputs: [], name: 'InvalidPaymentAmount', type: 'error' },
  { inputs: [], name: 'InvalidSignature', type: 'error' },
  { inputs: [], name: 'InvalidVoucher', type: 'error' },
  { inputs: [], name: 'NotApprovedNorOwner', type: 'error' },
  { inputs: [], name: 'TransferNotAllowed', type: 'error' },
  { inputs: [], name: 'ValueBelowCurrentSupply', type: 'error' },
  { inputs: [], name: 'ValueCannotBeZero', type: 'error' },
  { inputs: [], name: 'ValueExceedsMaxSupply', type: 'error' },
  { inputs: [], name: 'VoucherIsExpired', type: 'error' },
  { inputs: [], name: 'VoucherNonceTooLow', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'voucherNonce', type: 'uint256' },
    ],
    name: 'cancelVoucher',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'bool', name: 'soulbound_', type: 'bool' }],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'uint128', name: 'maxSupply_', type: 'uint128' },
      { internalType: 'bool', name: 'soulBound_', type: 'bool' },
  ...
  },
  {
    inputs: [
      {
        components: [
          { internalType: 'address', name: 'netRecipient', type: 'address' },
          {
            internalType: 'address',
  ...
  {
    inputs: [{ internalType: 'uint128', name: 'maxSupply_', type: 'uint128' }],
    name: 'setMaxSupply',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
