...
describe('Button', () => {
  it('should render appropriate element and classes when given no props', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-primary text-primary-foreground border-primary hover:bg-primary/80 rounded-full shadow-md-subtle px-3 py-1"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given secondary variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted primary-gradient-subtle text-primary/60 border-primary/10 rounded-lg hover:text-primary disabled:from-muted disabled:to-muted shadow-md-subtle px-3 py-1"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given text variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:text-muted-foreground bg-transparent text-primary/70 border-transparent hover:text-primary disabled:border-transparent disabled:bg-transparent shadow-md-subtle px-3 py-1"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given accent variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-accent text-accent-foreground border-accent rounded-full hover:bg-accent/70 hover:border-accent/30 shadow-md-subtle px-3 py-1"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given warning variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-warning text-warning-foreground border-warning rounded-full hover:bg-warning/70 hover:border-warning/30 shadow-md-subtle px-3 py-1"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given success variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-success text-success-foreground border-success rounded-full hover:bg-success/70 hover:border-success/30 shadow-md-subtle px-3 py-1"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given medium size value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-primary text-primary-foreground border-primary hover:bg-primary/80 rounded-full shadow-md-subtle px-4 py-1.5"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given large size value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-primary text-primary-foreground border-primary hover:bg-primary/80 rounded-full shadow-md-subtle px-4 py-2 gap-3 text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given extraLarge size value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex items-center font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-primary text-primary-foreground border-primary hover:bg-primary/80 rounded-full shadow-md-subtle px-5 py-2.5 gap-5 text-lg"
        >
          Text
        </button>
      </DocumentFragment>
