...
describe('Button', () => {
  it('should render appropriate element and classes when given no props', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-primary text-primary-foreground border-primary hover:bg-primary/80 rounded-full shadow-md-subtle px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given text variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:text-muted-foreground bg-transparent text-primary/70 border-transparent hover:text-primary disabled:border-transparent disabled:bg-transparent shadow-none px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given accent variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-accent text-accent-foreground border-accent rounded-full hover:bg-accent/70 hover:border-accent/30 shadow-md-subtle px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given warning variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-warning text-warning-foreground border-warning rounded-full hover:bg-warning/70 hover:border-warning/30 shadow-md-subtle px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given accentOutline variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-transparent text-accent border-accent rounded-full hover:bg-accent/30 hover:border-accent/30 shadow-md-subtle px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given warningOutline variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-transparent text-warning border-warning rounded-full hover:bg-warning/30 hover:border-warning/30 shadow-md-subtle px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
  ...
  it('should render appropriate element and classes when given successOutline variant value', () => {
    ...
    expect(asFragment()).toMatchInlineSnapshot(`
      <DocumentFragment>
        <button
          class="flex justify-center items-center gap-2 text-sm font-medium border disabled:bg-muted disabled:text-muted-foreground disabled:border-muted bg-transparent text-success border-success rounded-full hover:bg-success/30 hover:border-success/30 shadow-md-subtle px-3 py-1 max-sm:py-2 max-sm:text-base"
        >
          Text
        </button>
      </DocumentFragment>
