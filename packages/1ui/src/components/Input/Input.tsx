  ...
  ({ startAdornment, endAdornment, className, type, ...props }, ref) => {
    return (
      ...
      >
        ...
        <input
          type={type}
          className="flex w-full px-2 bg-transparent ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-none disabled:cursor-not-allowed disabled:opacity-50"
          ref={ref}
          {...props}
        />
