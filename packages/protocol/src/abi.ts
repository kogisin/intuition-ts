export const abi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'protocolVault', type: 'address', internalType: 'address' },
  ...
  { type: 'error', name: 'MultiVault_AdminOnly', inputs: [] },
  ...
  { type: 'error', name: 'MultiVault_AtomUriTooLong', inputs: [] },
  { type: 'error', name: 'MultiVault_BurnFromZeroAddress', inputs: [] },
  { type: 'error', name: 'MultiVault_BurnInsufficientBalance', inputs: [] },
  { type: 'error', name: 'MultiVault_DeployAccountFailed', inputs: [] },
  { type: 'error', name: 'MultiVault_DepositOrWithdrawZeroShares', inputs: [] },
  ...
  { type: 'error', name: 'MultiVault_InvalidExitFee', inputs: [] },
  { type: 'error', name: 'MultiVault_InvalidFeeSet', inputs: [] },
  { type: 'error', name: 'MultiVault_MinimumDeposit', inputs: [] },
  { type: 'error', name: 'MultiVault_OperationAlreadyExecuted', inputs: [] },
  { type: 'error', name: 'MultiVault_OperationAlreadyScheduled', inputs: [] },
  { type: 'error', name: 'MultiVault_OperationNotScheduled', inputs: [] },
  { type: 'error', name: 'MultiVault_ReceiveNotAllowed', inputs: [] },
  { type: 'error', name: 'MultiVault_TimelockNotExpired', inputs: [] },
  { type: 'error', name: 'MultiVault_TransferFailed', inputs: [] },
  {
    type: 'error',
  ...
  { type: 'error', name: 'MultiVault_VaultDoesNotExist', inputs: [] },
  {
    type: 'error',
    name: 'MultiVault_VaultIsTriple',
    inputs: [{ name: 'vaultId', type: 'uint256', internalType: 'uint256' }],
  },
  { type: 'error', name: 'MultiVault_VaultNotAtom', inputs: [] },
  { type: 'error', name: 'MultiVault_VaultNotTriple', inputs: [] },
